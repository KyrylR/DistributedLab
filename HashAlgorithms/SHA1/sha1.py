...
class Sha1Hash(object):
    ...
    def update(self, arg):
        ...
        :param arg: bytes, bytearray, or BytesIO object to read from.
        :return: Update the current digest.
        """
    ...
    def digest(self):
        """
        :return: the final hash value (big-endian) as a bytes object
        """
...
def sha1(input_str):
    ...
    :param input_str: A bytes or BytesIO object containing the input message to hash.
    :return: A hex SHA-1 digest of the input message.
    """
    return Sha1Hash().update(input_str).hexdigest()
